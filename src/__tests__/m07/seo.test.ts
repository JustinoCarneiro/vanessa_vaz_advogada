...
describe('M07 — SEO estrutural', () => {
  ...
  describe('Root layout (metadata global)', () => {
    ...
    it('tem robots index,follow', () => expect(c).toContain('index') && expect(c).toContain('follow'))
  ...
  describe('Schema.org — Artigo (Article)', () => {
    ...
    it('tem author com name Vanessa', () => expect(c).toContain('author') && expect(c).toContain('Vanessa'))
